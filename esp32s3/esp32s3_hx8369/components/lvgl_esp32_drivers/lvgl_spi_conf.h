...
#else
#define TFT_SPI_HOST    SPI2_HOST // HSPI_HOST
#endif
#elif defined (CONFIG_LV_TFT_DISPLAY_SPI_VSPI)
#define TFT_SPI_HOST    SPI3_HOST // VSPI_HOST
...
#define TOUCH_SPI_HOST SPI2_HOST	//HSPI_HOST
#elif defined (CONFIG_LV_TOUCH_CONTROLLER_SPI_VSPI)
#define TOUCH_SPI_HOST SPI3_HOST	//VSPI_HOST
