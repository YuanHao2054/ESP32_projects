...
#if defined (CONFIG_LV_TFT_DISPLAY_CONTROLLER_HX8369)

    disp_driver_init();
    //return;
#endif  //CONFIG_LV_TFT_DISPLAY_CONTROLLER_HX8369
...
/* Display controller initialization */
    ...
    disp_driver_init();
#elif defined(CONFIG_LV_TFT_DISPLAY_CONTROLLER_HX8369)    
    ESP_LOGI(TAG, "i80 master for display");
#else
    ...
    int quadwp_pin, int quadhd_pin)
{
    ...
    dma_chan = SPI_DMA_CH_AUTO /* SPI_DMA_CH_AUTO */;
