...
#define PIN_NUM_DATA3 16
#define PIN_NUM_DATA4 15
#define PIN_NUM_DATA5 7
#define PIN_NUM_DATA6 6
#define PIN_NUM_DATA7 5

#define PIN_NUM_WR 3 /* PCK */
...
// static esp_lcd_panel_io_handle_t set_vcom_cmd_io;
// static int set_vcom_cmd(int argc, char **argv)//设置VCOM
// {
//     uint8_t temp[2];
//     temp[0] = atoi(argv[1]);
//     temp[1] = atoi(argv[2]);
...
//     // SET VCOM
//     esp_lcd_panel_io_tx_param(set_vcom_cmd_io, 0xb6, temp,
//                               2);
//     ESP_LOGI("cmd","设置VCOM为%x %x", temp[0], temp[1]);
//     return 0;
// }
static esp_err_t panel_hx8369_init(esp_lcd_panel_t *panel)
{
    ...
    // Init LCD
    // set_vcom_cmd_io = io;
    // CONSOLE_REGISTER( "lcd_vcom" ,"设置lcd的vcom",NULL, set_vcom_cmd);
    // Set_EXTC
...
/* 官方PCB */
    // Set Power
    esp_lcd_panel_io_tx_param(io, 0xB1, (uint8_t[]){0x01, 0x00, 0x34, 0x07, 0x00, 0x01, 0x0F, 0x2a, 0x32, 0x3f, //
                                                    0x3f, 0x07, 0x10, 0x01, 0xe6, 0xe6, 0xe6, 0xe6, 0xe6},
                              19);
#endif
    ...
    esp_lcd_panel_io_tx_param(io, 0xb4, (uint8_t[]){0x00, 0x0C, 0xA0, 0x0E, 0x06},
                              5);
    // SET VCOM
    esp_lcd_panel_io_tx_param(io, 0xb6, (uint8_t[]){0x10, 0x10},
                              2);
    // SET GIP
